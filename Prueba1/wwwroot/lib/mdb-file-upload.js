    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                messages: { default: "Elija o suelte un ficheiro", replace: "Alterar", remove: "X", error: "Houve algum Erro" },
                error: {
                ...
                tpl: {
                    ...
                    message: '<div class="card-text file-upload-message"><i class="fa fa-upload"></i><p>{{ default }}</p></div>',
                    preview:
                    ...
                    clearButton: '<button type="button" class="btn btn-sm btn-danger">{{ remove }}</button>',
